...
Download the [OpenComposite Launcher](https://ci.appveyor.com/api/projects/ZNix/openovr/artifacts/OpenComposite.zip?branch=openxr&pr=false&job=Platform%3A+x64). Unzip it to a folder of your choosing,
...
Download the DLLs:
[32-bit](https://ci.appveyor.com/api/projects/ZNix/openovr/artifacts/Win32/openvr_api.dll?branch=openxr&pr=false&job=Platform%3A+Win32)
[64-bit](https://ci.appveyor.com/api/projects/ZNix/openovr/artifacts/x64/openvr_api.dll?branch=openxr&pr=false&job=Platform%3A+x64)
