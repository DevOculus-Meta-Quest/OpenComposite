    ...
    public partial class MainWindow : Form
    {
        ...
        private async Task<bool> UpdateDLLs()
        {
            ...
            if (!File.Exists(vrclient))
            {
                ...
                await DownloadFile(vrclient, "https://ci.appveyor.com/api/projects/ZNix/openovr/artifacts/Win32/openvr_api.dll?branch=openxr&job=Platform%3A+Win32");
            }
            ...
            if (!File.Exists(vrclient_x64))
            {
                ...
                await DownloadFile(vrclient_x64, "https://ci.appveyor.com/api/projects/ZNix/openovr/artifacts/x64/openvr_api.dll?branch=openxr&job=Platform%3A+x64");
            }
